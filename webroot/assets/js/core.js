...
(function (i) {
  ...
  e = function () {
    ...
    e.$slideTrack = 0 === e.slideCount ? i('<div  id="slickT" class="slick-track"/>').appendTo(e.$slider) : e.$slides.wrapAll('<div  id="slickT" class="slick-track"/>').parent(), 
    e.$list = e.$slideTrack.wrap('<div  class="slick-list"/>').parent(), e.$slideTrack.css("opacity", 0),  e.options.centerMode !== !0 && e.options.swipeToSlide !== !0 || (e.options.slidesToScroll = 1), 
    i("img[data-lazy]", e.$slider).not("[src]").addClass("slick-loading"), e.setupInfinite(), e.buildArrows(), e.buildDots(), e.updateDots(), e.setSlideClasses("number" == typeof e.currentSlide ? e.currentSlide : 0), 
  ...
  return (function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      var Countdown = function (el, options) {
        ...
        $(document.getElementById('slickT')).attr('style', 'width:3000;');
