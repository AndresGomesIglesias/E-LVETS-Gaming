...
<head>
	...
	<!-- Basic Page Needs
	================================================== -->
	<title>eSports &amp; Gaming HTML Template - Player Page</title>
	<meta charset="utf-8">
	...
	<div class="site-wrapper clearfix">
		...
		<div class="header-mobile clearfix" id="header-mobile">
			<div class="header-mobile__logo">
				<a href="_esports_index.html"><img src="assets/images/esports/logo.png" srcset="assets/images/esports/logo@2x.png 2x" alt="Alchemists" class="header-mobile__logo-img"></a>
			</div>
						...
						<nav class="main-nav">
							<ul class="main-nav__list">
									...
									<div class="main-nav__megamenu">
										<div class="row">
											...
											<ul class="col-lg-5 col-md-3 col-12 main-nav__ul main-nav__ul-3cols">
												...
												<li><a href="_esports_features-widgets-sports.html">Widgets - Sports</a></li>
								...
								<li class=""><a href="_esports_team-overview.html">The Team</a>
									<!-- Mega Menu -->
									<div class="main-nav__megamenu main-nav__megamenu--no-paddings main-nav__megamenu--has-bg">
										<div class="row">
			...
			<div class="container">
				<div class="row">
					<div class="col align-self-start">
						<h1 class="page-heading__title">Player <span class="highlight">Page</span></h1>
					</div>
					<div class="col align-self-end">
						<ol class="page-heading__breadcrumb breadcrumb font-italic">
							...
							<li class="breadcrumb-item"><a href="#">L.O. Heroes</a></li>
			...
			<div class="container">
						...
						<div class="card__content">
							<div class="team-roster__content-wrapper">
								...
								<figure class="team-roster__player-img">
									...
									<img src="assets/images/esports/samples/team-player2-lg.png" alt="">
								</figure>
								<!-- Player Photo / End-->
								...
								<div class="team-roster__content">
									...
									<div class="team-roster__player-details">
										<div class="team-roster__player-info">
											<h5 class="team-roster__player-realname">James Spiegel</h5>
											<h3 class="team-roster__player-nickname">The <span class="highlight">Destroy</span></h3>
										</div>
									</div>
									<!-- Player Details / End -->
									...
									<div class="team-roster__player-details-common">
										<div class="team-roster__player-metrics">
											<div class="team-roster__player-metrics-item">
												...
												<div class="team-roster__player-metrics-item-value">Los Angeles, CA</div>
											</div>
											<div class="team-roster__player-metrics-item">
												<h6 class="team-roster__player-metrics-item-label">Age:</h6>
												<div class="team-roster__player-metrics-item-value">18 Years</div>
											</div>
										</div>
											...
											<table class="progress-table progress-table--simple">
												<tbody>
													...
													<tr>
														...
														<td class="progress-table__progress-label progress-table__progress-label--highlight">602</td>
													</tr>
													<tr>
														...
														<td class="progress-table__progress-label progress-table__progress-label--highlight">349</td>
													</tr>
								...
								<aside class="team-roster__meta">
									...
									<div class="team-roster__meta-item">
										<a href="_esports_team-roster.html">
											...
											<div class="team-roster__meta-label">Go Back</div>
										</a>
									</div>
							...
							<div class="player-general-stats__card card">
								<div class="player-general-stats__card-content card__content">
									...
									<div class="player-general-stats__body">
										...
										<div class="player-general-stats__meta">
											<h6 class="player-general-stats__label">Average Pentakills</h6>
											<div class="player-general-stats__sublabel">in all time</div>
										</div>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-lg-8">
									...
									<table class="table table-hover game-player-result">
										...
										<tbody>
											...
											<tr>
												...
												<td class="game-player-result__character highlight text-left">Valholl (Offensive)</td>
											...
											<tr>
												...
												<td class="game-player-result__character highlight text-left">Ragnark (Offensive)</td>
												...
												<td class="game-player-result__mvp">
													<div class=" alc-icon alc-icon--circle alc-icon--xs alc-icon--outline alc-icon--outline-md">
														<i class="fa fa-star"></i>
													</div>
												</td>
											</tr>
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<!-- Widget: Doughnut Chart -->
								<aside class="widget card widget--sidebar">
									<div class="widget__title card__header">
										<h4>Doughnut Chart Stats</h4>
									</div>
									<div class="widget__content card__content">
										<canvas id="chart-doughnut-esports" height="208"></canvas>
										<div id="chartDoughnutLegendEsports" class="chart-legend chart-legend--center"></div>
									</div>
								</aside>
								<!-- Widget: doughnut Chart / End -->
						...
						<div class="card card--clean">
							<header class="card__header card__header--has-arrows js-posts-carousel-header">
							...
							<div class="card__content">
								...
								<div class="slick-carousel-wrapper">
									...
									<!-- Posts Grid -->
									<div class="posts posts--tile posts--tile-alt post-grid row posts-carousel js-posts-carousel">
		
										<div class="post-grid__item col-sm-6">
											<div class="posts__item posts__item--tile posts__item--category-2  card mb-0">
												<figure class="posts__thumb">
													<img src="assets/images/esports/samples/post-img2-card.jpg" alt="">
													<div class="posts__inner">
														<div class="posts__cat">
															<span class="label posts__cat-label posts__cat-label--category-2">L.O. Heroes</span>
														</div>
										...
										<div class="post-grid__item col-sm-6">
											<div class="posts__item posts__item--tile posts__item--category-3  card mb-0">
												<figure class="posts__thumb">
													<img src="assets/images/esports/samples/post-img8-card.jpg" alt="">
													<div class="posts__inner">
														<div class="posts__cat">
															<span class="label posts__cat-label posts__cat-label--category-3">Striker GO</span>
														</div>
										...
										<div class="post-grid__item col-sm-6">
											<div class="posts__item posts__item--tile posts__item--category-1 posts__item--category-3  card mb-0">
												<figure class="posts__thumb">
													<img src="assets/images/esports/samples/post-img3-card.jpg" alt="">
													<div class="posts__inner">
														<div class="posts__cat">
										...
										<div class="post-grid__item col-sm-6">
											<div class="posts__item posts__item--tile posts__item--category-4  card mb-0">
												<figure class="posts__thumb">
													<img src="assets/images/esports/samples/post-img4-card.jpg" alt="">
													<div class="posts__inner">
														<div class="posts__cat">
															<span class="label posts__cat-label posts__cat-label--category-4">Xenowatch</span>
														</div>
										...
										<div class="post-grid__item col-sm-6">
											<div class="posts__item posts__item--tile posts__item--category-2  card mb-0">
												<figure class="posts__thumb">
													<img src="assets/images/esports/samples/post-img5-card.jpg" alt="">
													<div class="posts__inner">
														<div class="posts__cat">
															<span class="label posts__cat-label posts__cat-label--category-2">L.O. Heroes</span>
														</div>
						...
						<!-- Player Related News / End -->
		
						<!-- Yearly Stats -->
						<div class="card">
							<div class="card__header card__header--has-legend">
								<h4>Yearly Stats</h4>
								<div id="gamesYearlyLegendEsports" class="chart-legend"></div>
							</div>
							<div class="card__content">
								<canvas id="yearly-history-esports" class="points-history-chart" height="127"></canvas>
							</div>
						</div>
						<!-- Yearly Stats / End -->
					...
					<div class="col-lg-4">
								...
								<div class="twitch-stream-wrapper">
									<a href="#" class="twitch-stream twitch-stream--featured twitch-stream--has-video card">
										...
										<div class="twitch-stream__body">
											<h6 class="twitch-stream__featured">Destroy&#x27;s Stream</h6>
									...
									<div class="twitch-stream-video card">
										<div class="card__content">
											<figure class="twitch-stream-video__clip">
												<a href="#" class="twitch-stream-video__link" target="_blank"><img src="assets/images/esports/samples/twitch-stream-cover.jpg" alt=""></a>
											</figure>
										</div>
									</div>
							...
							<div class="widget__content card__content">
								<ul class="team-stats-box">
									...
									<li class="team-stats__item team-stats__item--clean">
										...
										<div class="team-stats__value">355</div>
										<div class="team-stats__label">MVPs Awarded</div>
										<div class="team-stats__sublabel">in all time</div>
									</li>
									<li class="team-stats__item team-stats__item--clean">
										<div class="team-stats__icon team-stats__icon--circle-outline team-stats__icon--size-sm team-stats__icon--centered">
						
											<svg role="img" class="df-icon df-icon--coin">
												<use xlink:href="assets/images/esports/icons-esports.svg#coin"/>
											</svg>
						
										</div>
										<div class="team-stats__value">543.7</div>
										<div class="team-stats__label">Average Gold</div>
										<div class="team-stats__sublabel">in all time</div>
									</li>
									<li class="team-stats__item team-stats__item--clean">
										<div class="team-stats__icon team-stats__icon--circle-outline team-stats__icon--size-sm team-stats__icon--centered">
						
											<svg role="img" class="df-icon df-icon--drop">
												<use xlink:href="assets/images/esports/icons-esports.svg#drop"/>
											</svg>
						
										</div>
										<div class="team-stats__value">84.2%</div>
										<div class="team-stats__label">First Blood</div>
										<div class="team-stats__sublabel">in all time</div>
									</li>
									<li class="team-stats__item team-stats__item--clean">
										<div class="team-stats__icon team-stats__icon--circle-outline team-stats__icon--size-sm team-stats__icon--centered">
						
											<svg role="img" class="df-icon df-icon--stopwatch">
												<use xlink:href="assets/images/esports/icons-esports.svg#stopwatch"/>
											</svg>
						
										</div>
										<div class="team-stats__value">8:58</div>
										<div class="team-stats__label">Time Between Kills</div>
										<div class="team-stats__sublabel">average / in all time</div>
									</li>
						...
						<aside class="widget widget--sidebar card card--has-table widget-character-stats">
							<div class="widget__title card__header">
								<h4>Characters Played Stats</h4>
							</div>
							<div class="widget__content card__content">
						
								<div class="table-responsive">
									<table class="table character-stats-table">
										<thead>
											<tr>
												<th class="character-stat__player">Character</th>
												<th class="character-stat__total">M.Played</th>
												<th class="character-stat__win">Win Rate</th>
												<th class="character-stat__overal">K / D / A</th>
											</tr>
										</thead>
										<tbody>
						
											<tr>
												<td class="character-stat__player">
													<div class="character-stat__player-info alc-img-object">
														<figure class="character-stat__player-img alc-img-object__img alc-img-object__img--hexagon alc-img-object__img--hexagon-sm">
															<img src="assets/images/esports/samples/character-1-xs.jpg" alt="">
														</figure>
														<div class="character-stat__player-body alc-img-object__body">
															<h5 class="character-stat__player-name alc-img-object__title">Valholl</h5>
															<span class="character-stat__player-position alc-img-object__desc">Offensive</span>
														</div>
													</div>
												</td>
												<td class="character-stat__total highlight">12</td>
												<td class="character-stat__win highlight">71.4%</td>
												<td class="character-stat__overal highlight">
													3.7 / 1.6 / 4.7
												</td>
											</tr>
											<tr>
												<td class="character-stat__player">
													<div class="character-stat__player-info alc-img-object">
														<figure class="character-stat__player-img alc-img-object__img alc-img-object__img--hexagon alc-img-object__img--hexagon-sm">
															<img src="assets/images/esports/samples/character-2-xs.jpg" alt="">
														</figure>
														<div class="character-stat__player-body alc-img-object__body">
															<h5 class="character-stat__player-name alc-img-object__title">Ragnark</h5>
															<span class="character-stat__player-position alc-img-object__desc">Offensive</span>
														</div>
													</div>
												</td>
												<td class="character-stat__total highlight">7</td>
												<td class="character-stat__win highlight">86.2%</td>
												<td class="character-stat__overal highlight">
													2.8 / 1.5 / 7.5
												</td>
											</tr>
											<tr>
												<td class="character-stat__player">
													<div class="character-stat__player-info alc-img-object">
														<figure class="character-stat__player-img alc-img-object__img alc-img-object__img--hexagon alc-img-object__img--hexagon-sm">
															<img src="assets/images/esports/samples/character-3-xs.jpg" alt="">
														</figure>
														<div class="character-stat__player-body alc-img-object__body">
															<h5 class="character-stat__player-name alc-img-object__title">Jaxxy Reev</h5>
															<span class="character-stat__player-position alc-img-object__desc">Offensive</span>
														</div>
													</div>
												</td>
												<td class="character-stat__total highlight">4</td>
												<td class="character-stat__win highlight">100%</td>
												<td class="character-stat__overal highlight">
													3 / 2 / 8.3
												</td>
											</tr>
											<tr>
												<td class="character-stat__player">
													<div class="character-stat__player-info alc-img-object">
														<figure class="character-stat__player-img alc-img-object__img alc-img-object__img--hexagon alc-img-object__img--hexagon-sm">
															<img src="assets/images/esports/samples/character-4-xs.jpg" alt="">
														</figure>
														<div class="character-stat__player-body alc-img-object__body">
															<h5 class="character-stat__player-name alc-img-object__title">Bloodshid</h5>
															<span class="character-stat__player-position alc-img-object__desc">Defensive</span>
														</div>
													</div>
												</td>
												<td class="character-stat__total highlight">3</td>
												<td class="character-stat__win highlight">26.3%</td>
												<td class="character-stat__overal highlight">
													4.3 / 1.7 / 5
												</td>
											</tr>
											<tr>
												<td class="character-stat__player">
													<div class="character-stat__player-info alc-img-object">
														<figure class="character-stat__player-img alc-img-object__img alc-img-object__img--hexagon alc-img-object__img--hexagon-sm">
															<img src="assets/images/esports/samples/character-5-xs.jpg" alt="">
														</figure>
														<div class="character-stat__player-body alc-img-object__body">
															<h5 class="character-stat__player-name alc-img-object__title">Valkyrine</h5>
															<span class="character-stat__player-position alc-img-object__desc">Medic</span>
														</div>
													</div>
												</td>
												<td class="character-stat__total highlight">1</td>
												<td class="character-stat__win highlight">57.9%</td>
												<td class="character-stat__overal highlight">
													2 / 1.5 / 5.5
												</td>
											</tr>
								...
								<div class="alc-achievements js-alc-achievements-carousel">
									...
									<div class="alc-achievements__item">
										<div class="alc-achievements__content">
											...
											<h5 class="alc-achievements__event-title">Heroes Razz Tournament</h5>
											<div class="alc-achievements__event-date">August 2016</div>
										</div>
										<div class="alc-achievements__meta">
											...
											<div class="alc-achievements__meta-item">
												<h6 class="alc-achievements__meta-value">$80.000</h6>
						...
						<aside class="widget card widget--sidebar">
							...
							<div class="widget__content card__content">
								<canvas id="chart-horizontal-bars-esports" class="games-history-chart" height="230"></canvas>
							</div>
						</aside>
						<!-- Widget: Horizontal Bar Chart / End -->
